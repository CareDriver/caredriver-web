...
import { collection, addDoc, DocumentReference, getDoc, doc, setDoc } from "firebase/firestore"; 
 ...
 */
const saveUser = async (uid: string, userData: Omit<UserInterface, 'id'>): Promise<DocumentReference> => {
  try {
