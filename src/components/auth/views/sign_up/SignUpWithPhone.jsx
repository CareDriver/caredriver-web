    ...
    return linkState.readyToLink ? (
        ...
        <form onSubmit={onSignInSubmit}>
            <p className="text | small center | margin-bottom-25">
                Podrás seguir ingresando a nuestra Aplicación usando tu número
                de celular. Ademas no se perderán los datos que ya tienes en
                nuestra Aplicación.
            </p>
            ...
            <fieldset className="form-section">
                ...
                {phone.errorMessage.length > 0 && (
                    <small>{phone.errorMessage}</small>
                )}
            </fieldset>
