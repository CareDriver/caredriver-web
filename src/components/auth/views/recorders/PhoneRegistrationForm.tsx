...
const PhoneRegistrationForm = () => {
    ...
    try {
      await toast.promise(
        ...
        }),
        {
          ...
          error:
            "Error al agregar numero de celular, intentalo de nuevo por favor",
        },
      );
  ...
  }, [checkingUserAuth, router, user, userProps.hasPhone]);
  ...
  return (
    <div className="service-form-wrapper | max-height-100">
      ...
      <p className="text | light">
        Nuestros administradores podran contactarte de manera mas rapida si
        agregas tu numero de celular.
      </p>
      ...
      {view === View.VERIFYING_CODE && (
        <div className="max-width-60">
          <CodeVerifier onSummbit={addPhone} verificationCode={form.code} />
        </div>
      )}
