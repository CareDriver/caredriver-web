...
const driveRequestedServicesColl = collection(
  firestore,
...
const towRequestedServicesColl = collection(
  firestore,
  Collections.TowsServices,
);
const laundryRequestedServicesColl = collection(
  firestore,
  Collections.CarWashServices,
);

export const getServiceRequestedCollection = (type: ServiceType) => {
  switch (type) {
    case "driver":
