    ...
    <div className="form-sub-container | margin-top-25 margin-bottom-25 max-width-60">
      ...
      {IS_DRIVER && (
        <div className="service-user-wrapper | with-data">
          ...
          <UserServerRatingRenderer serviceData={user.servicesData.Conductor} />
          ...
          <Link
            ...
            href={
              user.fakeId
                ? routeToServicesServedByUser("driver", user.fakeId)
                : routeToNoFound()
            }
          >
            <Eye />
      ...
      {IS_MECHANIC && (
        <div className="service-user-wrapper  | with-data">
          ...
          <UserServerRatingRenderer serviceData={user.servicesData.Mecánico} />
          ...
          <Link
            href={
              user.fakeId
                ? routeToServicesServedByUser("mechanical", user.fakeId)
                : routeToNoFound()
            }
            className="icon-wrapper text  | underline gray-icon gray-dark | margin-top-15"
          >
      ...
      {IS_CRANE_OPERATOR && (
        <div className="service-user-wrapper  | with-data">
          ...
          <UserServerRatingRenderer serviceData={user.servicesData.Remolque} />
          ...
          <Link
            ...
            href={
              user.fakeId
                ? routeToServicesServedByUser("tow", user.fakeId)
                : routeToNoFound()
            }
          >
            <Eye />
      ...
      {IS_LAUNDERER && (
        <div className="service-user-wrapper  | with-data">
          ...
          <UserServerRatingRenderer serviceData={user.servicesData.Lavadero} />
          ...
          <Link
            href={
              user.fakeId
                ? routeToServicesServedByUser("laundry", user.fakeId)
                : routeToNoFound()
            }
            className="icon-wrapper text  | underline gray-icon gray-dark | margin-top-15"
          >
