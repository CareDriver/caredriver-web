...
import PersonalDataV2 from "../../../users/views/data_renderers/PersonalDataV2";
...
import UserStateRenderer from "../../data_renderers/UserStateRenderer";
import UserVerifierPrompter from "../../data_renderers/UserVerifierPrompter";
...
const ReviewFormForAddingBranding = ({ reqId }: { reqId: string }) => {
...
export default ReviewFormForAddingBranding;
 */