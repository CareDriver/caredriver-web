...
import { getUserById, updateUser } from "@/components/app_modules/users/api/UserRequester";
import {
...
import WorkshopEnterpriseRenderer from "../../../../enterprises/views/data_renderers/WorkshopEnterpriseRenderer";
...
import MechanicToolsRenderer from "../../data_renderers/for_mechanics/MechanicToolsRenderer";
                ...
                if (isLimitToReviews) {
                    if (requesterUser) {
                        ...
                        if (wasApproved && serviceReq.mechanicalWorkShop) {
                            ...
                            if (
                                !requesterUser.services.includes(
                                    Services.Mechanic,
                                )
                            ) {
                                userToUpdate = {
        ...
        <div className="service-form-wrapper | max-width-60">
            ...
            >
                ...
                {enterprise === null ? (
                    ...
                    <WorkshopEnterpriseRenderer workshop={enterprise} />
                )}
                ...
                {requesterUser && (
                    <UserStateRenderer user={requesterUser} />
                )}
            </BaseFormWithTwoButtons>
        </div>
    );
...
export default MechanicReviewForm;
