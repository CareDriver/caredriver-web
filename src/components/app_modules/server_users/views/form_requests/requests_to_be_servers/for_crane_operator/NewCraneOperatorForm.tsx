...
import { isValidVehicle } from "@/components/app_modules/server_users/validators/VehicleValidator";
                ...
                try {
                    ...
                    if (form.vehicle.license.expirationDate.value) {
                        vehiclesData = {
                            ...
                            license: {
                                licenseNumber:
                                    form.vehicle.license.number.value,
        ...
        if (!form.enterprise.value) {
            setForm((prev) => ({
                ...
                enterprise: {
                    ...prev.enterprise,
                    message:
                        "Por favor selecciona la Empresa de Grúa en la que trabajas",
                },
            }));
            return;
        }
        ...
        requesterUser && (
            <div className="service-form-wrapper">
                <ServiceStateRenderer
                    statusHandler={
                        new CraneOperatorStatusHandler(requesterUser)
                    }
                />
