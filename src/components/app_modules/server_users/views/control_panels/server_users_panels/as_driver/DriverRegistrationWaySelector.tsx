    ...
    return (
        <div className="margin-top-25">
            <h3 className="text | medium-big bold icon-wrapper">
                <CircleQuestion /> Elige una de estas formas para de ser{" "}
                {DRIVER} de {NAME_BUSINESS}
            </h3>
            <div className="row-wrapper margin-top-15">
                <button
                    className={`small-general-button touchable icon-wrapper | lb ${
                        registrationWay !==
                            DriverRegistration.CallingEnterprise && "gray"
                    }`}
                    onClick={() =>
                ...
                <button
                    className={`small-general-button touchable icon-wrapper | lb ${
                        registrationWay !== DriverRegistration.Independent &&
                        "gray"
                    }`}
                    onClick={() =>
                        setRegistrationWay(DriverRegistration.Independent)
                    }
                >
