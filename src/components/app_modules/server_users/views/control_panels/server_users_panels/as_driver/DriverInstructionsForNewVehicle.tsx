...
const DriverInstructionsForNewVehicle = () => {
  ...
  const getMissingVehicle = (user: UserInterface): "car" | "motorcycle" => {
    const hasMotorcycleRegistered: boolean =
      user.serviceVehicles !== undefined && !user.serviceVehicles.motorcycle;
  ...
  return (
    <div className="margin-top-5">
      <p className="text | gray-dark bold">
        Registra este vehiculo para que nuestros usuarios puedan solicitar{" "}
        {DRIVER_PLURAL} para este vehiculo.
      </p>
      <Link
