        ...
        try {
          ...
          if (oldEnterprise) {
            const logoChanged: boolean =
              ...
              oldEnterprise.logoImgUrl.url !== enterpriseEditDoc.logoImgUrl.url;
            ...
            if (logoChanged) {
              await toast.promise(deleteFile(oldEnterprise.logoImgUrl.ref), {
                ...
                error:
                  "Error al remplazar el logo, inténtalo de nuevo por favor",
              });
            }
            ...
            router.push(
              routeToRequestsToEditEnterpriseAsAdmin(enterpriseEditDoc.type),
            );
          } else {
            toast.error(
              `${
  ...
  return (
    <section className="service-form-wrapper | max-width-60">
      <h1 className="text | big-medium bold margin-bottom-25 capitalize">
        ...
        {ENTERPRISE_TO_SPANISH_WITH_UNDEFINITE_ARTICLE[enterpriseEditDoc.type]}
      </h1>
        ...
        content={{
          ...
          secondButton: {
            content: {
              legend: "Aprobar",
              buttonClassStyle:
                wasReviewed() || enteprise.deleted ? "hidden" : undefined,
            },
            behavior: {
              loading: reviewState.loading,
              setLoading: (l) =>
