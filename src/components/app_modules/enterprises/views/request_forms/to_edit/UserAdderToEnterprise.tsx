...
const UserAdderToEnterprise: React.FC<Props> = ({ userLogged, enterprise }) => {
  ...
  const getEnterpriseUserAdder = (
    ...
    if (typeAdder === "ServerUser" && enterprise.id) {
      ...
      return (
        <NewUserSupportForm userToAdd={userToAdd} enterprise={enterprise} />
      );
    }
  };
        ...
        <div className="service-form-wrapper">
          ...
          <div className="margin-top-25">
            <h2 className="text | medium-big bold | icon-wrapper lb">
              <Users />
              Registrar usuarios servidores | Agregar usuarios soporte
            </h2>
            ...
            <div className="margin-top-25">
              ...
              <div className="margin-top-15 row-wrapper">
                ...
                <button
                  ...
                  onClick={() => registerAsSupportUser(userToAdd.data)}
                  disabled={!formState.isValid}
                >
                  <UserGear />
                  Usuario Soporte
...
function getValidator(
  ...
  switch (enterprise.type) {
    ...
    case "mechanical":
      return new ValidatorToAddUserToWorkshopEnterpriseAsMember(enterprise);
    case "laundry":
      return new ValidatorToAddUserToLaundryEnterpriseAsMember(enterprise);
    default:
