  ...
  return (
    <li className="sidebar-options | margin-bottom-25">
      ...
      <Link
        ...
        className={`sidebar-option ${
          pathname.includes(routeToAllEnterprisesAsAdmin("mechanical")) &&
          "selected"
        }`}
      >
        <Warehouse />
      ...
      <Link
        ...
        className={`sidebar-option ${
          pathname.includes(routeToAllEnterprisesAsAdmin("tow")) && "selected"
        }`}
      >
        <Building />
      ...
      <Link
        ...
        className={`sidebar-option ${
          pathname.includes(routeToAllEnterprisesAsAdmin("laundry")) &&
          "selected"
        }`}
      >
        <Soap />
